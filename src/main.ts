...
export default class HappyGua {
    ...
    constructor(options: Options, callback: Function) {
        this.cover = null;
        this.ctx = null;
    ...
    function _endEventHandler(event) {
        event.preventDefault();
        if (this.defaultOptions.callback && typeof this.defaultOptions.callback === 'function') _calcArea.call(this,this.ctx, this.defaultOptions.callback, this.defaultOptions.ratio);
